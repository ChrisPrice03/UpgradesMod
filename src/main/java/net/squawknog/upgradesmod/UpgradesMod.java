package net.squawknog.upgradesmod;
...
@Mod(UpgradesMod.MOD_ID)
public class UpgradesMod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "upgradesmod";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();
    public UpgradesMod(FMLJavaModLoadingContext context)
    {
...
//            event.accept(ModItems.UPGRADE_TOKEN);
//        }
    }
