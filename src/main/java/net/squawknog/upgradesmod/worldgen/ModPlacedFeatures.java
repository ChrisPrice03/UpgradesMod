...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> FLAME_UPGRADER_PLACED_KEY = registerKey("flame_upgrader_placed");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, FLAME_UPGRADER_PLACED_KEY,
                configuredFeatures.getOrThrow(ModConfiguredFeatures.FLAME_UPGRADER_KEY),
                List.of(
                        RarityFilter.onAverageOnceEvery(192), // Controls the rarity of spawning
                        PlacementUtils.HEIGHTMAP_WORLD_SURFACE, // Spawns at the world surface
                        BiomeFilter.biome() // Make it spawn in any biome (adjust as needed)
